    ...
    val screen =
      preferenceScreen(context) {
        ...
        selectableList(
          ...
          valuesText =
            arrayOf(R.string.follow_system_android_10, R.string.always_light, R.string.always_dark),
          icon = R.drawable.ic_baseline_brightness_4,
          title = R.string.dark_mode,
        ) {
          listener = OnChangedListener { requests.trySend(Request.ReCreateAllActivities) }
        }
        ...
        switch(
          ...
          listener = OnChangedListener { onHideIconChange(uiStore::hideAppIcon.get()) }
        }
