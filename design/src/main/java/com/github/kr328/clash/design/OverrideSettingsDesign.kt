    ...
    val screen =
      preferenceScreen(context) {
        ...
        selectableList(
          ...
          values =
            arrayOf(null, TunnelState.Mode.Direct, TunnelState.Mode.Global, TunnelState.Mode.Rule),
          valuesText =
            arrayOf(
        ...
        val dns =
          selectableList(
            ...
            valuesText =
              arrayOf(R.string.dont_modify, R.string.force_enable, R.string.use_built_in),
            title = R.string.strategy,
          ) {
            listener = OnChangedListener {
              if (configuration.dns.enable == false) {
                dnsDependencies.forEach { it.enabled = false }
              } else {
                dnsDependencies.forEach { it.enabled = true }
              }
            }
          }
        ...
        selectableList(
          ...
          valuesText =
            arrayOf(R.string.dont_modify, R.string.disabled, R.string.fakeip, R.string.mapping),
        ...
        selectableList(
          ...
          valuesText = arrayOf(R.string.dont_modify, R.string.blacklist, R.string.whitelist),
