...
constructor(
  ...
  private val binding = ComponentActionTextFieldBinding.inflate(context.layoutInflater, this, true)
  ...
  init {
    context.theme
      .obtainStyledAttributes(attributeSet, R.styleable.ActionTextField, defStyleAttr, defStyleRes)
      .apply {
        try {
