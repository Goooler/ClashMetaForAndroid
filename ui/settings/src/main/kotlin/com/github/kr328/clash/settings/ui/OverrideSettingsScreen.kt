...
private fun OverrideSettingsContent(
  ...
  MihomoScaffold(
    title = stringResource(SettingsR.string.override),
...
private fun LazyListScope.generalPreferenceItems(
  ...
  preferenceCategory(
    key = "cat_general",
    title = { Text(stringResource(SettingsR.string.general)) },
  )
  overrideEditTextPreferenceItem(
    key = "httpPort",
    title = SettingsR.string.http_port,
    placeholder = SettingsR.string.dont_modify,
  ...
  overrideEditTextPreferenceItem(
    key = "socksPort",
    title = SettingsR.string.socks_port,
    placeholder = SettingsR.string.dont_modify,
    emptyLabel = R.string.disabled,
  ...
  overrideEditTextPreferenceItem(
    key = "redirectPort",
    title = SettingsR.string.redirect_port,
    placeholder = SettingsR.string.dont_modify,
    emptyLabel = R.string.disabled,
  ...
  overrideEditTextPreferenceItem(
    key = "tproxyPort",
    title = SettingsR.string.tproxy_port,
    placeholder = SettingsR.string.dont_modify,
    emptyLabel = R.string.disabled,
  ...
  overrideEditTextPreferenceItem(
    key = "mixedPort",
    title = SettingsR.string.mixed_port,
    placeholder = SettingsR.string.dont_modify,
    emptyLabel = R.string.disabled,
  ...
  preference(
    ...
    title = { Text(stringResource(SettingsR.string.authentication)) },
    summary = { Text(configuration.authentication.listSummary(SettingsR.string.dont_modify)) },
    onClick = {
      onOpenEditableTextList(
        SettingsR.string.authentication,
  ...
  listPreference(
    ...
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.allow_lan)) },
  ...
  listPreference(
    ...
    values = booleanOptions,
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.ipv6)) },
    summary = { Text(stringResource(configuration.ipv6.textRes)) },
    valueToText = { AnnotatedString(stringResource(it.textRes)) },
  )
  overrideEditTextPreferenceItem(
    key = "bindAddress",
    title = SettingsR.string.bind_address,
    placeholder = SettingsR.string.dont_modify,
  ...
  overrideEditTextPreferenceItem(
    ...
    title = SettingsR.string.external_controller,
    placeholder = SettingsR.string.dont_modify,
    emptyLabel = R.string.default_,
  ...
  overrideEditTextPreferenceItem(
    ...
    title = SettingsR.string.external_controller_tls,
    placeholder = SettingsR.string.dont_modify,
    emptyLabel = R.string.default_,
  ...
  preference(
    key = "allowOrigins",
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.allow_origins)) },
    summary = {
      Text(
        configuration.externalControllerCors.allowOrigins.listSummary(SettingsR.string.dont_modify)
      )
    },
    onClick = {
      onOpenEditableTextList(
        SettingsR.string.allow_origins,
  ...
  listPreference(
    ...
    values = booleanOptions,
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.allow_private_network)) },
    summary = {
  ...
  listPreference(
    ...
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.log_level)) },
  ...
  preference(
    key = "hosts",
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.hosts)) },
    summary = { Text(configuration.hosts.summary(SettingsR.string.dont_modify)) },
    onClick = {
      onOpenEditableTextMap(SettingsR.string.hosts, configuration.hosts, actions::updateHosts)
    },
  )
}
...
private fun LazyListScope.dnsPreferenceItems(
  ...
  preferenceCategory(key = "cat_dns", title = { Text(stringResource(SettingsR.string.dns)) })
  listPreference(
    key = "dnsStrategy",
    value = dnsEnabled,
  ...
  listPreference(
    ...
    title = { Text(stringResource(SettingsR.string.prefer_h3)) },
    summary = { Text(stringResource(configuration.dns.preferH3.textRes)) },
    valueToText = { AnnotatedString(stringResource(it.textRes)) },
  )
  overrideEditTextPreferenceItem(
    key = "dnsListen",
    title = SettingsR.string.listen,
    placeholder = SettingsR.string.dont_modify,
    emptyLabel = R.string.disabled,
  ...
  listPreference(
    ...
    modifier = Modifier.fillMaxWidth(),
    enabled = dnsEnabled != false,
    title = { Text(stringResource(SettingsR.string.append_system_dns)) },
  ...
  listPreference(
    ...
    modifier = Modifier.fillMaxWidth(),
    enabled = dnsEnabled != false,
    title = { Text(stringResource(SettingsR.string.use_hosts)) },
  ...
  listPreference(
    ...
    modifier = Modifier.fillMaxWidth(),
    enabled = dnsEnabled != false,
    title = { Text(stringResource(SettingsR.string.enhanced_mode)) },
  ...
  preference(
    key = "dnsNameServer",
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.name_server)) },
    summary = { Text(configuration.dns.nameServer.listSummary(SettingsR.string.dont_modify)) },
    enabled = dnsEnabled != false,
    onClick = {
      onOpenEditableTextList(
        SettingsR.string.name_server,
  ...
  preference(
    key = "dnsFallback",
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.fallback)) },
    summary = { Text(configuration.dns.fallback.listSummary(SettingsR.string.dont_modify)) },
    enabled = dnsEnabled != false,
    onClick = {
      onOpenEditableTextList(
        SettingsR.string.fallback,
  ...
  preference(
    ...
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.default_name_server)) },
    summary = { Text(configuration.dns.defaultServer.listSummary(SettingsR.string.dont_modify)) },
    enabled = dnsEnabled != false,
    onClick = {
      onOpenEditableTextList(
        SettingsR.string.default_name_server,
  ...
  preference(
    key = "dnsFakeIpFilter",
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.fakeip_filter)) },
    summary = { Text(configuration.dns.fakeIpFilter.listSummary(SettingsR.string.dont_modify)) },
    enabled = dnsEnabled != false,
    onClick = {
      onOpenEditableTextList(
        SettingsR.string.fakeip_filter,
  ...
  listPreference(
    ...
    modifier = Modifier.fillMaxWidth(),
    enabled = dnsEnabled != false,
    title = { Text(stringResource(SettingsR.string.fakeip_filter_mode)) },
  ...
  listPreference(
    ...
    modifier = Modifier.fillMaxWidth(),
    enabled = dnsEnabled != false,
    title = { Text(stringResource(SettingsR.string.geoip_fallback)) },
    summary = { Text(stringResource(configuration.dns.fallbackFilter.geoIp.textRes)) },
    valueToText = { AnnotatedString(stringResource(it.textRes)) },
  )
  overrideEditTextPreferenceItem(
    key = "dnsGeoIpCode",
    title = SettingsR.string.geoip_fallback_code,
    placeholder = SettingsR.string.dont_modify,
    emptyLabel = SettingsR.string.raw_cn,
  ...
  preference(
    ...
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.domain_fallback)) },
    summary = {
      Text(configuration.dns.fallbackFilter.domain.listSummary(SettingsR.string.dont_modify))
    },
    enabled = dnsEnabled != false,
    onClick = {
      onOpenEditableTextList(
        SettingsR.string.domain_fallback,
  ...
  preference(
    ...
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.ipcidr_fallback)) },
    summary = {
      Text(configuration.dns.fallbackFilter.ipcidr.listSummary(SettingsR.string.dont_modify))
    },
    enabled = dnsEnabled != false,
    onClick = {
      onOpenEditableTextList(
        SettingsR.string.ipcidr_fallback,
  ...
  preference(
    ...
    modifier = Modifier.fillMaxWidth(),
    title = { Text(stringResource(SettingsR.string.name_server_policy)) },
    summary = { Text(configuration.dns.nameserverPolicy.summary(SettingsR.string.dont_modify)) },
    enabled = dnsEnabled != false,
    onClick = {
      onOpenEditableTextMap(
        SettingsR.string.name_server_policy,
...
private val Boolean?.dnsStrategyTextRes: Int
  ...
  get() =
    when (this) {
      true -> SettingsR.string.force_enable
      false -> SettingsR.string.use_built_in
      null -> SettingsR.string.dont_modify
    }
...
private val LogMessage.Level?.textRes: Int
  ...
  get() =
    when (this) {
      Info -> SettingsR.string.info
      Warning -> SettingsR.string.warning
      LogMessage.Level.Error -> SettingsR.string.error
      Debug -> SettingsR.string.debug
      Silent -> SettingsR.string.silent
...
private val ConfigurationOverride.DnsEnhancedMode?.textRes: Int
  ...
  get() =
    when (this) {
      ...
      FakeIp -> SettingsR.string.fakeip
      Mapping -> SettingsR.string.mapping
      null -> SettingsR.string.dont_modify
    }
...
private val ConfigurationOverride.FilterMode?.textRes: Int
  ...
  get() =
    when (this) {
      BlackList -> SettingsR.string.blacklist
      WhiteList -> SettingsR.string.whitelist
      null -> SettingsR.string.dont_modify
    }
